...
foreach ($vehiculos as $tracker){
    ...
    foreach($eventos as $evento){
        ...
        $Qry="INSERT INTO `masgps`.`speedPullman` (`cuenta`, `id_tracker`, `patente`, `fecha`, `start_time`, `duration`, `max_speed`, `lat`, `lng`) 
        VALUES ('Pullman', '$id_tracker', '$pat', '$ayer', '$start_time', '$duration', '$max_speed', '$lat', '$lng');
        ";
